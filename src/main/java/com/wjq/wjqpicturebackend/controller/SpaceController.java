...
public class SpaceController {
    ...
    public BaseResponse<SpaceVO> getSpaceVOById(Long id, HttpServletRequest request) {
        ...
        spaceQueryRequest.setId(id);
        //设置查询条件，只能查询所属用户自己的空间
        spaceQueryRequest.setUserId(userService.getLoginUser(request).getId());
        // 查询数据库
        Space space = spaceService.getOne(spaceService.getQueryWrapper(spaceQueryRequest));
        ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR);
        // 获取封装类
