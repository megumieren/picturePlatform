package com.wjq.wjqpicturebackend.manager.auth;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.wjq.wjqpicturebackend.manager.auth.model.SpaceUserAuthConfig;
import com.wjq.wjqpicturebackend.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionsByRole(String spaceUserRole) {
        ...
        List<SpaceUserRole> roleList = SPACE_USER_AUTH_CONFIG.getRoles();
        // 找到匹配的角色
        SpaceUserRole role = roleList.stream()
